...
RUN curl -o app.jar https://artifactory.imatia.com/public-artifactory/sg-releases-local/com/imatia/sg/sg-rest-shp2pgsql-postgis-docker/0.0.2/sg-rest-shp2pgsql-postgis-docker-0.0.2.jar
